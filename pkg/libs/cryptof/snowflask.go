...
// source: https://github.com/bwmarrin/snowflake
...
var ErrInvalidBase58 = fmt.Errorf("invalid base58")

// ErrInvalidBase32 is returned by ParseBase32 when given an invalid []byte
var ErrInvalidBase32 = fmt.Errorf("invalid base32")
...
func NewNode(node int64) (*Node, error) {
	...
	if n.node < 0 || n.node > n.nodeMax {
		return nil, fmt.Errorf("Node number must be between 0 and " + strconv.FormatInt(n.nodeMax, 10))
	}
